...
import 'package:gravitus_app_v1/screens/marketpage/p2pordersscreen/p2p_sellers/sellerorder_screen.dart';
import 'package:gravitus_app_v1/styles/styles.dart';

class P2pBuySellCards extends StatelessWidget {
  const P2pBuySellCards({Key key}) : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Flexible(
                  fit: FlexFit.tight,
                  child: Text('', style: buyorderstyle1),
                ),
                Flexible(
                  fit: FlexFit.tight,
                  child: Padding(
            ...
            Row(
              children: [
                ...
                Flexible(
                  fit: FlexFit.tight,
                  child: Text('', style: buyorderstyle2),
                ),
                Flexible(child: Text('')),
              ],
            ),
        ...
        Positioned(
          child: Container(
            ...
            child: ElevatedButton(
              ...
              // onPressed: () {
              //   Navigator.of(context).push(CustomPageRoute(
              //     child: BuyorderDeatils(),
              //     direction: AxisDirection.left,
              //   ));
              //   // Navigator.push(context,
              //   //     MaterialPageRoute(builder: (context) => BuyorderDeatils()));
              // },
              child: Text('View', style: cancelstyle),
            ),
          ),
          bottom: 15,
          right: 16,
